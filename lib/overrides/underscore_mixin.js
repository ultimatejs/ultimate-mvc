	...
	babelExtend: function(obj) {
	    ...
	    if(source) {
          ...
          descriptor = Object.getOwnPropertyDescriptor(source, prop);
					...
					var specialProp = /relations|subscriptions|aggregates|mixins|behaviors|mixinHelpers|mixinEvents|mixinCallbacks/.test(prop);
					
					if(descriptor && !specialProp) Object.defineProperty(obj, prop, descriptor);
					else obj[prop] = source[prop];  
				});
	    }
    });
