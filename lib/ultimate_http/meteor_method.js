UltimateHttp.extend({
	...
	allowedHttpMethod: function(name, userId, obj, args) {
		...
		if(_.isFunction(perms && perms.allowHttpInstance)) isAllowed = perms.allowHttpInstance.apply(this, newArgs);
		if(_.isFunction(perms && perms.allowHttpStatic)) isAllowed = perms.allowHttpStatic.apply(this, newArgs);
