Ultimate('UltimateRelationsPublisherFactory').extends({
	...
	publishCollectionAggregate: function() {
		...
		var aggColPub = new UltimateAggregateCollectionPublisher(this, this.publisher, this.aggregates, this.modelClass, this.cachedIdsByCollection);
		aggColPub.start();
	},
	...
	_handleRelation: function(parent, options, name) {
		...
		var rp = this._createRelationPublisher(rel, options);
