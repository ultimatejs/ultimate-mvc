Ultimate('UltimateRelationsPublisherFactory').extends({
	...
	publishCollectionAggregate: function() {
		...
		_.each(this.aggregates, function(aggregate) {
			var aggColPub = new UltimateAggregateCollectionPublisher(this, this.publisher, aggregate, this.modelClass, this.cachedIdsByCollection);
			aggColPub.start();
		}, this);
	},
	...
	_createAggregatePublisher: function(aggregates, rel, parent) {
		...
		_.each(aggregates, function(aggregate) {
			var aggPub = new UltimateAggregateRelationsPublisher(this, this.publisher, aggregate, rel.model, rel.agg_selector, this.cachedIdsByCollection);
