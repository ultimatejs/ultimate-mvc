Ultimate('UltimateComponentParent').extends(UltimateReactive, {
  ...
  _deniedRegex: /^(colors|model|tableColumns|onCreated|onRendered|onDestroyed|ar|sub|subLimit|autoruns|subscriptions|subscriptionLimits|onReady|onStop)(\s|$)/,
	...
	_animationsRegex: /^(animateOnChildInsert|animateOnChildRemoved|animateOnChildInsertAndRendered|animateOnChildRendered|animateOnRendered)(\s|$)/,
