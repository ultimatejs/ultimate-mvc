UltimateComponentParent.extend({
	...
	instance: function(prop, val) { //alias for this.componentInstance()
		return this.currentInstance(prop, val);
	},
	...
	firstNode: function() {
		return this.componentInstance().firstNode;
	},
	lastNode: function() {
	...
	getReactiveDict: function(store) {
		if(store == 'limit-store') return this.callParent('getReactiveDict');
		else return this.componentInstance()._reactiveDict = this.componentInstance()._reactiveDict || new ReactiveDict;
	}
