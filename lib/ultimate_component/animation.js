UltimateComponentParent.extend({
	...
	__queueAnimation: function(methodKey, type, context, handler, node, next) {
		...
		console.log('ANIMATION', type, handler, methodKey);
		...
		this.___animationTimers[methodKey] = Meteor.setTimeout(function() {
			Tracker.afterFlush(function() {
				...
				if(_.isArray(handler) && _.isInt(_.last(handler))) handler.pop(); //remove the delay integer from the array, its not needed anymore
