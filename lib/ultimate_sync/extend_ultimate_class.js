UltimateClass.extendBoth({
	...
	bindEnvironment: function(nameOrFunc, onException) {
		if(_.isString(nameOrFunc)) nameOrFunc = this[name];
		if(_.isFunction(onException)) onException = onException.bind(this);
		
		return Meteor.bindEnvironment(nameOrFunc, onException, this)
	}
});