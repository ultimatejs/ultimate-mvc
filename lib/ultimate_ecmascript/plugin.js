...
BCp.processFilesForTarget = function (inputFiles) {
  inputFiles.forEach(function (inputFile) {
		var source = raiseUltimateClassScope(inputFile); //ONE OF 2 LINES ADDED TO STANDARD ECMASCRIPT PACKAGE
    ...
    if (fileOptions.transpile !== false) {
      ...
      toBeAdded.sourceMap = result.map;
		...
		toBeAdded.data = raiseClassScope(transpileToUltimate(toBeAdded.data, inputFile)); //2ND LINE ADDED
