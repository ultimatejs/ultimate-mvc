...
//Call the original instance aggregate methods, but from a simple agg method
//that takes the aggregate name as a parameter.
UltimateModel.extend({
	agg: function(name, callback) {
		return this[name+'Agg'](callback);
	}
});