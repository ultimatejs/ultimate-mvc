...
_.extend(Ultimate, {
  ...
  reservedWordsRegex: /^(construct|class|className|__type|parent|constructor|___proto|createNew|abstract|_forms|_schema|defaults|mixins|schema|collection|_behaviors|_listeners|forms|collectionName|tableName|cloneNumber|_attachedMixins|mixinTo|strict|behaviors|_originalDoc|___complete)$/,
	...
	prototypeFrom: function(Class) {
		return _.isString(Class) ? this.classes[Class].prototype : (Class.isStatic ? Class.prototype : Class);
	},
