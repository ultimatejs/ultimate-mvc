_.extend(Ultimate, {
  ...
  setupForm: function() {
    ...
    if(this.methods.forms) this.forms();
		if(this.methods.defineErrorMessages || this.methods.errorMessages) this.defineErrorMessages();
  },
	...
	defineErrorMessages: function() {
		var messages = this.methods.defineErrorMessages || this.methods.errorMessages;
