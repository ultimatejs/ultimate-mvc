_.extend(Ultimate, {
  ...
  configureStatics: function() {
    ...
    //Class.extendStatic() does not exist on classes until after this call
  	this.staticInheritParent.call(this.class, this.parent);
	},
	staticInheritParent: function(Parent) {
		return UltimateClone.deepExtendOwnUltimate(this, Parent, function(method, name) {
