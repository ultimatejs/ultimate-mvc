_.extend(Ultimate, {
  addMethods: function (proto, methods, isClassCreation, shouldEmit) {
		...
		proto.class.mixinClasses(methods.mixins); 													//	 Mixins will recursively call this `addMethods` method (without emitting addMethods!)
		...
		if(shouldEmit !== false) proto.emit('addMethods', methods); 				//D. emit 'onAddMethods' for mixins to hook into (after all mixins attached)
