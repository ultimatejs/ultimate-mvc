Ultimate('UltimateConfig').extends(UltimateFacade, {
	...
	setEnvId: function(envId) {	
		...
		else this._envId = Ultimate.rootUrl.stripTrailingSlash(); //this.envId is deleted and undefined is passed when development.auto is replaced as an environment
