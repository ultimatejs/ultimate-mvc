UltimateBraintree = Ultimate('UltimateBraintree').extends({ //will be moved to package
  ...
  //privateKey: 
	...
	tokenizeCard: function(options, customerId, callback) {
		...
		this._braintree = this._braintree || braintree; //assign it first time it's needed, since braintree js wont be loaded before onChildStartup
